      ...
      <div className="px-6 md:px-12 w-full max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center space-y-6 mb-16">
          ...
          <p className="text-lg text-text-muted font-light max-w-xl mx-auto pt-4 leading-relaxed px-4">
            Whether you have a groundbreaking idea or a team in need of a MERN specialist, I'm just
            a message away. Let's create something extraordinary together.
          </p>
        </div>

        {/* Contact Grid — 1 col mobile, 3 col on lg (email = 2 cols) */}
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="lg:col-span-2 neo-flat p-8 md:p-14 rounded-[32px] md:rounded-[48px] flex flex-col justify-between group hover:neo-concave transition-all duration-500 relative overflow-hidden"
          >
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-text-muted font-light">
                  The fastest way to get a project estimate or interview invitation.
                </p>
              </div>
            </div>

            <div className="mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-6 relative z-10">
              <a
                href="mailto:haris.rindh.pk@gmail.com"
                className="w-full xl:w-max neo-btn px-5 sm:px-10 py-3.5 sm:py-5 rounded-[20px] sm:rounded-full font-display text-sm md:text-xl text-text hover:text-accent flex items-center justify-center space-x-2 sm:space-x-3 transition-all duration-300 group/btn hover:shadow-[0_0_24px_rgba(49,130,206,0.3)]"
              >
            ...
            <span className="absolute bottom-[-5px] sm:bottom-[-10px] right-2 sm:right-8 font-display text-[3.5rem] sm:text-[5rem] font-bold text-accent/5 pointer-events-none select-none uppercase z-0">
              EMAIL
            </span>
          </motion.div>
          ...
          >
            <h3 className="text-xl font-display font-bold text-text uppercase tracking-widest text-center mt-2">
              Social Connect
            </h3>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <div className="flex items-center space-x-4">
                  <div className="w-10 h-10 neo-concave rounded-xl flex items-center justify-center text-[#25D366]">
