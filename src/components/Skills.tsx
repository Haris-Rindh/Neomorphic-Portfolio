...
const skillCategories = [
  {
    ...
    icon: Layout,
    description: 'Crafting pixel-perfect, responsive, and animated web interfaces with modern frameworks and tools.',
    color: 'text-accent',
    items: [
      { name: 'React / Next.js', level: 'Expert' },
      { name: 'TypeScript', level: 'Advanced' },
      { name: 'Tailwind / CSS3', level: 'Expert' },
  ...
  },
  {
    title: 'Backend & APIs',
    icon: Database,
    description: 'Building robust REST APIs, real-time systems, and full-stack applications end-to-end.',
    color: 'text-accent',
    items: [
      { name: 'Node.js / Express', level: 'Expert' },
      { name: 'MongoDB', level: 'Expert' },
      { name: 'Firebase / Firestore', level: 'Advanced' },
      { name: 'Socket.io / WebRTC', level: 'Advanced' },
      { name: 'REST API Design', level: 'Expert' },
      { name: 'Stripe Payments', level: 'Intermediate' },
    ]
  },
  {
    title: 'Tooling & Deployment',
    icon: Wrench,
    description: 'Shipping production-grade apps with modern toolchains, CI/CD, and cloud deployment.',
    color: 'text-accent',
    items: [
  ...
  },
  {
    ...
    icon: Shield,
    description: 'Going beyond the basics — SEO, performance, security, and AI-powered features.',
    color: 'text-accent',
    items: [
      ...
      { name: 'E-commerce Dev', level: 'Advanced' },
    ]
  }
];
